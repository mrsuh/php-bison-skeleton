...
/**
 * A Bison parser, automatically generated from <tt>/Users/newuser/web/home/php-bison-skeleton/bin/../examples/calc-pull-locations/grammar.y</tt>.
 *
...
interface LexerInterface {
     ...
     * @return Position the position at which the last scanned token starts.
     */
    public function getStartPos(): Position;

    /**
     * Method to retrieve the ending position of the last scanned token.
     * @return Position the first position beyond the last scanned token.
     */
  ...
  class Location {
     ...
     * @param Position $begin The first position included in the range.
     * @param Position $end   The first position beyond the range.
     */
...
class Parser
{
  ...
  private function yyaction(int $yyn, YYStack $yystack, int $yylen): int
  {
    ...
    /* "/Users/newuser/web/home/php-bison-skeleton/bin/../examples/calc-pull-locations/grammar.y":13  */
                                   { printf("%d\n", $yystack->valueAt(0)); };
  break;


  case 3: /* expression: T_NUMBER  */
    /* "/Users/newuser/web/home/php-bison-skeleton/bin/../examples/calc-pull-locations/grammar.y":17  */
                                   { $yyval = $yystack->valueAt(0); };
  break;


  case 4: /* expression: expression '+' expression  */
    /* "/Users/newuser/web/home/php-bison-skeleton/bin/../examples/calc-pull-locations/grammar.y":18  */
                                   { $yyval = $yystack->valueAt(2) + $yystack->valueAt(0);  };
  break;


  case 5: /* expression: expression '-' expression  */
    /* "/Users/newuser/web/home/php-bison-skeleton/bin/../examples/calc-pull-locations/grammar.y":19  */
                                   { $yyval = $yystack->valueAt(2) - $yystack->valueAt(0);  };
  break;



/* "/Users/newuser/web/home/php-bison-skeleton/bin/../examples/calc-pull-locations/parser.php":494  */
...
/* "/Users/newuser/web/home/php-bison-skeleton/bin/../examples/calc-pull-locations/grammar.y":22  */
