...
/**
 * A Bison parser, automatically generated from <tt>/Users/newuser/web/home/php-bison-skeleton/bin/../examples/calc-pull-locations-int/grammar.y</tt>.
 *
...
class Parser
{
  ...
  private function yyaction(int $yyn, YYStack $yystack, int $yylen): int
  {
    ...
    /* "/Users/newuser/web/home/php-bison-skeleton/bin/../examples/calc-pull-locations-int/grammar.y":13  */
                                   { printf("%d\n", $yystack->valueAt(0)); };
  break;


  case 3: /* expression: T_NUMBER  */
    /* "/Users/newuser/web/home/php-bison-skeleton/bin/../examples/calc-pull-locations-int/grammar.y":17  */
                                   { $yyval = $yystack->valueAt(0); };
  break;


  case 4: /* expression: expression '+' expression  */
    /* "/Users/newuser/web/home/php-bison-skeleton/bin/../examples/calc-pull-locations-int/grammar.y":18  */
                                   { $yyval = $yystack->valueAt(2) + $yystack->valueAt(0);  };
  break;


  case 5: /* expression: expression '-' expression  */
    /* "/Users/newuser/web/home/php-bison-skeleton/bin/../examples/calc-pull-locations-int/grammar.y":19  */
                                   { $yyval = $yystack->valueAt(2) - $yystack->valueAt(0);  };
  break;



/* "/Users/newuser/web/home/php-bison-skeleton/bin/../examples/calc-pull-locations-int/parser.php":494  */
...
/* "/Users/newuser/web/home/php-bison-skeleton/bin/../examples/calc-pull-locations-int/grammar.y":22  */
