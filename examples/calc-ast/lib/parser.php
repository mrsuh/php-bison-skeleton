...
/* "lib/parser.php":255  */
  ...
  case 3: /* expression: T_NUMBER  */
    /* "grammar.y":19  */
                             { $yyval = new Node('NUMBER', $yystack->valueAt(0)); };
  break;


  case 4: /* expression: expression '+' expression  */
    /* "grammar.y":20  */
                             { $yyval = new Node('OPERATION_PLUS', '', [$yystack->valueAt(2), $yystack->valueAt(0)]);  };
  break;


  case 5: /* expression: expression '-' expression  */
    /* "grammar.y":21  */
                             { $yyval = new Node('OPERATION_MINUS', '', [$yystack->valueAt(2), $yystack->valueAt(0)]);  };
  break;
