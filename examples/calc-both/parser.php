...
/**
 * A Bison parser, automatically generated from <tt>/Users/newuser/web/home/php-bison-skeleton/bin/../examples/calc-both/grammar.y</tt>.
 *
...
class Parser
{
  ...
  private function yyaction(int $yyn, YYStack $yystack, int $yylen): int
  {
    ...
    /* "/Users/newuser/web/home/php-bison-skeleton/bin/../examples/calc-both/grammar.y":10  */
                                   { printf("%d\n", $yystack->valueAt(0)); };
  break;


  case 3: /* expression: T_NUMBER  */
    /* "/Users/newuser/web/home/php-bison-skeleton/bin/../examples/calc-both/grammar.y":14  */
                                   { $yyval = $yystack->valueAt(0); };
  break;


  case 4: /* expression: expression '+' expression  */
    /* "/Users/newuser/web/home/php-bison-skeleton/bin/../examples/calc-both/grammar.y":15  */
                                   { $yyval = $yystack->valueAt(2) + $yystack->valueAt(0);  };
  break;


  case 5: /* expression: expression '-' expression  */
    /* "/Users/newuser/web/home/php-bison-skeleton/bin/../examples/calc-both/grammar.y":16  */
                                   { $yyval = $yystack->valueAt(2) - $yystack->valueAt(0);  };
  break;



/* "/Users/newuser/web/home/php-bison-skeleton/bin/../examples/calc-both/parser.php":416  */
...
/* "/Users/newuser/web/home/php-bison-skeleton/bin/../examples/calc-both/grammar.y":19  */
